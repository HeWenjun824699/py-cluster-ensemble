...
def rpkmeans(
    ...
    Utilizes the Johnson-Lindenstrauss lemma to project data into a lower-dimensional
    subspace via a random Gaussian matrix before clustering. It induce diversity
    while maintaining the distance structure.
    ...
    projection_ratio : float, default=0.5
        Ratio of the target projection dimension to the original dimension.
    seed : int, default=2026
        Seed for the random projection matrix and K-Means initialization.
    maxiter : int, default=100
        Maximum iterations for internal K-Means.
    replicates : int, default=1
        Number of K-Means runs in the projected space.
