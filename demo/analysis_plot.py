...
X, Y = pce.io.load_mat_X_Y('./data/isolet_1560n_617d_2c.mat')
pce.analysis.plot_2d_scatter(
    X, Y,
    xlabel='Dimension 1',
    ylabel='Dimension 2',
    method='tsne',
    title='isolet_1560n_617d_2c Ground Truth',
    save_path='./data/png/X_Y_tsne.png'
)

# 场景 B: 绘制共协矩阵热力图
BPs, Y = pce.io.load_mat_BPs_Y('./data/generators/CDKM200/isolet_1560n_617d_2c_CDKM200.mat')
pce.analysis.plot_coassociation_heatmap(
    ...
    title='isolet_1560n_617d_2c_CDKM200 HeatMap',
    save_path='./data/png/BPs_Y_heatmap.png'
)

# 场景 C: 绘制聚类指标折线图
with open('./data/grid/GridSearch_001/isolet_1560n_617d_2c_CDKM200/Exp_001_LWEA/metrics.json') as f:
...
pce.analysis.plot_metric_line(
    ...
    ylabel='Score',
    title='isolet_1560n_617d_2c_CDKM200 Metrics',
    save_path='./data/png/line_plot.png'
)

# 场景 D: 绘制参数敏感度分析折线图
csv_file = './data/grid/GridSearch_001/isolet_1560n_617d_2c_CDKM200/isolet_1560n_617d_2c_CDKM200.csv'
